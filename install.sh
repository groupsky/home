...
if [ "$(uname)" == "Darwin" ]; then
    ...
    sudo aptitude install git mc python-setuptools python-dev compizconfig-settings-manager compiz-plugins build-essential libyaml-dev curl
    ...
    wget -qO- https://gist.github.com/groupsky/3747983/raw/73bebae7b15cdf0477c45a92b0f18ad17f8f28ba/adb_usb.ini > $HOME/.android/adb_usb.ini
